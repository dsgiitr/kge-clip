...
### Readme Sections:
1. [Access the Dataset](https://github.com/dsgiitr/kge-clip/tree/main#1-access-the-dataset)
2. [Creating Traditional Vector Embeddings](https://github.com/dsgiitr/kge-clip/tree/main#2-creating-traditional-vector-embeddings)
3. [Embeddings Visualization in 3D](https://github.com/dsgiitr/kge-clip/tree/main#3-embeddings-visualization-in-3d)
4. [Generating Knowledge Graphs](https://github.com/dsgiitr/kge-clip/tree/main#4-generating-knowledge-graphs)
...
<div align="center">
  <img src="https://github.com/user-attachments/assets/56c36af5-b9b5-40db-b3a3-737a3b72b042" width=700 height=400>
</div>
